    ...
    case FIELD_TYPE.HERO: {
      ...
      popoverContent = (
        <TableBody>
          ...
          <TableRow key={`${idd}-health`}><TableCell align="left">Health</TableCell><TableCell align="right">{health}</TableCell></TableRow>
    ...
    case FIELD_TYPE.ENEMY_BULLET: {
      ...
      popoverContent = (
        <TableBody>
          ...
          <TableRow key={`${idd}-health`}><TableCell align="left">Health</TableCell><TableCell align="right">{health}</TableCell></TableRow>
          <TableRow key={`${idd}-moveProbability`}><TableCell align="left">Move Probability</TableCell><TableCell align="right">{moveProbability}</TableCell></TableRow>
          <TableRow key={`${idd}-shootProbability`}><TableCell align="left">Shoot Probability</TableCell><TableCell align="right">{shootProbability}</TableCell></TableRow>
          <TableRow key={`${idd}-bulletDamage`}><TableCell align="left">Bullet Damage</TableCell><TableCell align="right">{bulletDamage}</TableCell></TableRow>
